...
st.write('ขอย้ำว่า ผลการประเมินและคำแนะนำที่ได้รับจากโปรแกรมนี้ไม่สามารถใช้แทนการตัดสินใจของแพทย์ได้ การตรวจรักษาเพิ่มเติมหรือการให้ยารักษาขึ้นอยู่กับดุลยพินิจของแพทย์และการปรึกษากันระหว่างแพทย์และตัวท่าน')
...
def user_input_feature():
        ...
        st.sidebar.write('ฟอร์มกรอกข้อมูล')
...
with col1:
    ...
    if submit:
        if (final_result_asfloat < 50.0) :
            col2.write(f'ความน่าจะเป็นที่คุณจะเป็นโรคหัวใจคือ  {final_result_asfloat:.2f}  % คุณสุขภาพดี!')
            col2.image('images/good.jpg',width=350, caption='Dr. Emotional Damage')
        else:
            col2.write(f'ความน่าจะเป็นที่คุณจะเป็นโรคหัวใจคือ  {final_result_asfloat:.2f}  % สุขภาพของคุณมีความเสี่ยงต่อการเป็นโรคหัวใจ')
            col2.image('images/bad.jfif',width=350, caption='Dr. Emotional Damage')  