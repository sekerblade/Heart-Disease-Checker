...
st.markdown(
    '<span style="color:red;">** ระบบทำนายโรคหัวใจนี้เหมาะสำหรับผู้ที่มีอายุตั้งแต่ 18 ปีขึ้นไป</span>',
    unsafe_allow_html=True
)
st.write('หากต้องการทำนายสถานะโรคหัวใจของคุณ เพียงทำตามขั้นตอนต่อไปนี้ได้เลย:')
#st.write('ระบบทำนายโรคหัวใจนี้นี้เหมาะสำหรับผู้ที่มีอายุตั้งแต่ 18 ปีขึ้นไป:')

st.write('1. กรอกฟอร์มทางด้านซ้ายให้ครบถ้วน')
st.write('2. กดที่ปุ่ม "ทำนาย" แล้วรอผลประเมินได้เลย')

st.markdown(
    '<span style="color:orange;">** ขอย้ำว่า ผลการประเมินที่ได้รับจากโปรแกรมนี้ไม่สามารถใช้แทนการตัดสินใจของแพทย์ได้ การตรวจรักษาเพิ่มเติมขึ้นอยู่กับดุลยพินิจและการปรึกษากันระหว่างแพทย์กับตัวท่าน</span>',
    unsafe_allow_html=True
)
